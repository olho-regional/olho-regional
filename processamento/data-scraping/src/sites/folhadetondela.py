"""Handler for folhadetondela.pt — WordPress news site with flat permalinks.

96.9% text_too_short errors (533) — 2-segment WordPress attachment pages.
...
class FolhaDeTondelaHandler(BaseSiteHandler):
    DOMAINS = ["folhadetondela.pt", "www.folhadetondela.pt"]
    NAME = "folhadetondela"
